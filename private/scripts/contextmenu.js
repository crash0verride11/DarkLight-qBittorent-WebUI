    ...
    const TorrentsTableContextMenu = new Class({
        ...
        updateCategoriesSubMenu: function(category_list) {
            ...
            categoryList.appendChild(new Element('li', {
                html: '<a href="javascript:torrentNewCategoryFN();"><div class="listAdd ctxt_icon"></div> QBT_TR(New...)QBT_TR[CONTEXT=TransferListWidget]</a>' /*CHANGES*/
            }));
            categoryList.appendChild(new Element('li', {
                html: '<a href="javascript:torrentSetCategoryFN(0);"><div class="ctxt_icon editClearIcon"></div> QBT_TR(Reset)QBT_TR[CONTEXT=TransferListWidget]</a>' /*CHANGES*/
            }));
            ...
            Object.each(sortedCategories, function(categoryName) {
                ...
                const el = new Element('li', {
                    html: '<a href="javascript:torrentSetCategoryFN(\'' + categoryHash + '\');"><div class="folder_icon ctxt_icon" style="top: 4px;"></div> ' + window.qBittorrent.Misc.escapeHtml(categoryName) + '</a>' /*CHANGES*/
                });
                if (first) {
